 ...
 */
public class Base32Vitor extends BaseNCodec {
     ...
     */
    public Base32Vitor(final byte pad) {
        this(false, pad);
    }
     ...
     */
    public Base32Vitor(final boolean useHex) {
     ...
     * @param pad byte used as padding byte.
     */
    public Base32Vitor(final boolean useHex, final byte pad) {
     ...
     *            decoding.
     */
    public Base32Vitor(final int lineLength) {
     ...
     */
    public Base32Vitor(final int lineLength, final byte[] lineSeparator) {
     ...
     */
    public Base32Vitor(final int lineLength, final byte[] lineSeparator, final boolean useHex) {
